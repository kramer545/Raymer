...
public class WaveSpectrumGPU
{
	...
	void GenerateWavesSpectrum()
	{
		...
		EncodeFloat.WriteIntoRenderTexture2D(m_spectrum01, 4, spectrum01);
		EncodeFloat.WriteIntoRenderTexture2D(m_spectrum23, 4, spectrum23);
	...
	void CreateWTable()
	{
		...
		//Write floating point data into render texture
		EncodeFloat.WriteIntoRenderTexture2D(m_WTable, 4, table);
